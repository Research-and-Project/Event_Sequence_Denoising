...
# 标志
trainState = 1  # 1-train; 2-finetune
predflag = 1
t1 = time()
in_data_flag = 2
...
model_dir = "ConvDAE_3_3-diff-tanh--" +  timestamp
model_path = model_root_path + model_dir

if not os.path.isdir(model_path):
   os.makedirs(model_path)

train_log_dir = 'logs/train/ConvDAE_3_3-diff_'+timestamp
test_log_dir = 'logs/test/ConvDAE_3_3-diff_'+timestamp
